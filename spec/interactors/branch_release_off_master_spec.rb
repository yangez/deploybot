...
RSpec.describe BranchReleaseOffMaster do
  ...
  before do
    ...
    allow_any_instance_of(BranchReleaseOffMaster).to receive(:github).and_return(github_stub)
  end

  subject(:branch_release_off_master) { BranchReleaseOffMaster.call }

  it { is_expected.to be_success }

  it "has the correct message" do
    expect(branch_release_off_master.message).to include "Release branch created"
  end
